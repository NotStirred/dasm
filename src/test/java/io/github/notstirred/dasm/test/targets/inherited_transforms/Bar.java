...
public class Bar implements IBar {
    ...
    @AddFieldToSets(containers = TestUnitInheritedTransformsAddToSets.A.Foo_to_Bar_redirects.class, field = "fooField3:I")
    ...
    @AddMethodToSets(containers = TestUnitInheritedTransformsAddToSets.A.Foo_to_Bar_redirects.class, method = "fooRedirected()V")
