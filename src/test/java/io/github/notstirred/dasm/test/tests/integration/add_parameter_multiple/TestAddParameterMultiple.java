package io.github.notstirred.dasm.test.tests.integration.add_parameter_multiple;
...
@Dasm(value = TestAddParameterMultiple.Set.class, target = @Ref(AddParameterMultipleInput.class))
public class TestAddParameterMultiple extends BaseMethodTest {
    ...
    @TransformFromMethod("method2(Ljava.lang.String;Ljava.lang.String;Ljava.lang.String;)[Ljava.lang.String;")
    ...
    @TransformFromMethod("method3(JJ)[Ljava.lang.String;")
